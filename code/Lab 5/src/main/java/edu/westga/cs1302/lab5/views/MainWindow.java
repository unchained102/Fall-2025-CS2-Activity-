...
public class MainWindow {
	...
	private void loadStudents() {
		try {
			Student[] students = StudentDataPersistenceManager.loadStudentData(StudentDataPersistenceManager.FILE_LOCATION);
	...
	void saveStudents(ActionEvent event) {
		try {
			StudentDataPersistenceManager.saveStudentData(this.students.getItems().toArray(new Student[0]), StudentDataPersistenceManager.FILE_LOCATION);
