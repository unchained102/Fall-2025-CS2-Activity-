...
class TestCompare {
	...
	void testO1IsNull() {
		...
		DescendingPriority descendingPriority = new DescendingPriority();
		
		assertThrows(IllegalArgumentException.class, ()->{descendingPriority.compare(null, o2);});
	}
	...
	void testO2IsNull() {
		...
		assertThrows(IllegalArgumentException.class, ()->{descendingPriority.compare(o1, null);});
	}
	...
	void testO1HighAndO2MEDIUM() {
		...
		int result = descendingPriority.compare(o1, o2);
